...
/**
 * 插画排行榜全屏页（薄壳）：分段 Tab / 日期筛选 / 平板双栏交互全部在共享
 * [IllustRankingScreen]，本壳仅注入标题/空态资源与 [IllustRankingViewModel]（7 段插画 mode）。
 *
 * @param onBack 返回
...
fun IllustRankingRoute(
    ...
    IllustRankingScreen(
        title = stringResource(R.string.illust_ranking_title),
